...
const Login = (props) => {
  ...
  const authForm = (
    <form className="authForm">
      ...
      <div className="waves-effect waves-light button primary" onClick={loginHandler}>
        Войти
      </div>
      <div
        className="waves-effect waves-light button success"
        onClick={() => statusFormHandler(isRegistration)}>
        Регистрация
      </div>
    </form>
  );
  const registrationForm = (
    <form className="authForm">
      ...
      <div className="waves-effect waves-light button primary" onClick={registerHandler}>
        Зарегистрироваться
      </div>
      <div
        className="waves-effect waves-light button success"
        ...
        <div className="col s6">
          <div className="block_login_description">
            ...
            <p>
              ...
              tortor eget felis porttitor volutpat. Vestibulum ante ipsum primis Curabitur non nulla
              sit amet nisl tempus convallis quis ac
            </p>
          </div>
        </div>
        <div className="col s6">{!isRegistration ? authForm : registrationForm}</div>
      </div>
    </div>
  );
};
