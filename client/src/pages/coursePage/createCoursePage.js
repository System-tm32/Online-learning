...
class CreateCoursePage extends React.Component {
	...
	inputChangeHandler = (e) => {
		this.setState({
			body: {
			...this.state.body, [e.target.name]: e.target.value
			}
		})
	}
				...
				<div className="col l12">
					<form className="createCourse_form">
					  <div className="input-field">
				          <input id="course_name" type="text"  name="title" onChange={this.inputChangeHandler}/>
					...
					<h3>Задание</h3>
			          <div className="input-field">
				          <textarea id="course_hw" className="materialize-textarea" name="homeWork"  onChange={this.inputChangeHandler}/>
